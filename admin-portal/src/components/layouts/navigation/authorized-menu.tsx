      ...
      >
        ...
        >
          ...
          <div className="space-y-0.5 py-2">
            <Menu.Item>
              <li className="cursor-pointer border-dashed border-gray-200 px-2">
                <Link
                  href="/profile"
            ...
            <Menu.Item>
              <li className="cursor-pointer border-dashed border-gray-200 px-2 last:!mt-2.5 last:border-t last:pt-2">
                <Link
                  href="/logout"
                  className="group flex items-center gap-2 rounded-md py-2.5 px-3 text-sm capitalize transition duration-200 hover:text-accent"
                >
